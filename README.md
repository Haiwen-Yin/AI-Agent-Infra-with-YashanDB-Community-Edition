...
> **v4.4.14 · Community Edition · YashanDB**
>
...
```bash
bash scripts/install_platform.sh initialize --version v4.4.14 --database yashandb --edition <community|enterprise> --config config.json
```
