...
> **v4.4.13 · Community Edition · YashanDB**
>
...
```bash
bash scripts/install_platform.sh initialize --version v4.4.13 --database yashandb --edition <community|enterprise> --config config.json
```
