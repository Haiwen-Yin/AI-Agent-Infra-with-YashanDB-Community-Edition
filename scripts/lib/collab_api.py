"""AI Agent Infra v4.4.12 - Community Edition - Legacy execution-group API.
...
def create_collab_group(
    ...
    sql = f"""
        ...
        VALUES ({group_id_sql}, :name, :gtype, :descr, :wsid, :coord, :policy,
                'ACTIVE', :meta, :vbrid, :vsid, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
