"""AI Agent Infra v4.4.16 - Community Edition - Web Visualization Server
    ...
    def _serve_template(self, filename):
        ...
        try:
            with open(filepath, 'r', encoding='utf-8') as f:
                html = f.read()
            timeout = _session_timeout()
            html = html.replace('4.4.16', VERSION)
            html = html.replace('2026-09-23', os.environ.get('AI_AGENT_RELEASE_DATE', ''))
