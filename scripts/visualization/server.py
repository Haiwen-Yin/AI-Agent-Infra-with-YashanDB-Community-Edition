"""AI Agent Infra v4.3.6 - Community Edition - Web Visualization Server
    ...
    def _serve_template(self, filename):
        ...
        try:
            with open(filepath, 'r', encoding='utf-8') as f:
                html = f.read()
            timeout = _session_timeout()
            html = html.replace('4.3.6', VERSION)
            html = html.replace('2026-08-07', os.environ.get('AI_AGENT_RELEASE_DATE', ''))
