#!/usr/bin/env bash
# Chuanxu v4.4.9 - AI Agent Infra v4.4.9 - {{EDITION_LABEL}} unified FastAPI/Uvicorn server controller.
...
export AI_AGENT_RELEASE_DATE="2026-08-18"
...
start_server() {
  ...
  echo "Starting Chuanxu v4.4.9 ($DB_DIALECT, $PROFILE) on $HOST:$PORT"
