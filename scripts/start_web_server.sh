#!/usr/bin/env bash
# Chuanxu v4.3.7 - AI Agent Infra v4.3.7 - {{EDITION_LABEL}} unified FastAPI/Uvicorn server controller.
...
export AI_AGENT_RELEASE_DATE="2026-08-10"
...
start_server() {
  ...
  echo "Starting Chuanxu v4.3.7 ($DB_DIALECT, $PROFILE) on $HOST:$PORT"
