#!/usr/bin/env bash
# Chuanxu v4.4.3 - AI Agent Infra v4.4.3 - {{EDITION_LABEL}} unified FastAPI/Uvicorn server controller.
...
export AI_AGENT_RELEASE_DATE="2026-08-13"
...
start_server() {
  ...
  echo "Starting Chuanxu v4.4.3 ($DB_DIALECT, $PROFILE) on $HOST:$PORT"
