#!/usr/bin/env bash
# Chuanxu v4.3.6 - AI Agent Infra v4.3.6 - {{EDITION_LABEL}} unified FastAPI/Uvicorn server controller.
...
export AI_AGENT_RELEASE_DATE="2026-08-07"
...
start_server() {
  ...
  echo "Starting Chuanxu v4.3.6 ($DB_DIALECT, $PROFILE) on $HOST:$PORT"
