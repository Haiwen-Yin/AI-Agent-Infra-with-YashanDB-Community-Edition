#!/usr/bin/env bash
# Chuanxu v4.4.5 - AI Agent Infra v4.4.5 - {{EDITION_LABEL}} unified FastAPI/Uvicorn server controller.
...
export AI_AGENT_RELEASE_DATE="2026-08-15"
...
start_server() {
  ...
  echo "Starting Chuanxu v4.4.5 ($DB_DIALECT, $PROFILE) on $HOST:$PORT"
