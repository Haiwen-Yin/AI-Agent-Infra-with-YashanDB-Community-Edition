#!/usr/bin/env bash
# Chuanxu v4.4.8 - AI Agent Infra v4.4.8 - {{EDITION_LABEL}} unified FastAPI/Uvicorn server controller.
...
start_server() {
  ...
  echo "Starting Chuanxu v4.4.8 ($DB_DIALECT, $PROFILE) on $HOST:$PORT"
