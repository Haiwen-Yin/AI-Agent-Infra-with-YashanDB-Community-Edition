"""AI Agent Infra v4.4.12 - Credential & Pool Agent Tests"""
...
def test_register_agents():
    ...
    try:
        ...
        execute("INSERT INTO SYSTEM_USERS (USER_ID, USERNAME, PASSWORD_HASH, STATUS, ROLE, AUTH_SOURCE, CREATED_AT, UPDATED_AT) VALUES (:user_id, :user_name, 'SHA256:placeholder', 'ACTIVE', 'USER', 'LOCAL', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)", {"user_id": USER, "user_name": "cred_test_user"})
    except Exception:
        pass
