"""AI Agent Infra v4.0.0 - Pytest Configuration and Shared Fixtures
...
DB_CONFIGS: Dict[str, Dict[str, Any]] = {
    "oracle": {
        ...
        "pool_min": 1,
        "pool_max": 2,
        "select_dummy": "SELECT 1 AS val FROM DUAL",
    },
    "pg": {
        "driver": "psycopg2",
...
def pytest_report_header(config) -> List[str]:
    ...
    lines = [
        "AI Agent Infra v4.0.0 - parameterized DB fixtures",
