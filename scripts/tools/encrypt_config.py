...
"""AI Agent Infra v4.4.12 - Config Encryption CLI Tool
...
from lib.connection_crypto import (
    ...
    _DB_SENSITIVE_KEYS, _SECURITY_SENSITIVE_KEYS,
    _LLM_SENSITIVE_KEYS, _ROUTING_SENSITIVE_KEYS,
)

_ALL_SECTIONS = {
    "database": _DB_SENSITIVE_KEYS,
    "security": _SECURITY_SENSITIVE_KEYS,
...
def cmd_verify(args):
    ...
    for section_name in _ALL_SECTIONS:
        ...
        try:
            ...
            masked = {
                k: "****" if k in ("password", "api_key", "secret_key") else v
