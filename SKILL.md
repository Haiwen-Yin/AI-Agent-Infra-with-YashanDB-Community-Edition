...
> **Version:** 4.4.15 | **Driver:** yaspy 1.2.1 | **DB:** YashanDB 23.5.4+ (崖山数据库)
...
YashanDB (崖山数据库) is developed by 深圳崖山科技有限公司 (Shenzhen Yashan
...
```bash
# 1. Extract the zip
unzip AI-Agent-Infra-with-YashanDB-Enterprise-Edition-v4.4.15.zip
