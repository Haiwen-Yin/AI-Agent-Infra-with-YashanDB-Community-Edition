# AGENTS.md - AI Agent Infra with DB v4.4.8 Unified Repository Guide

> **v4.4.8** - The unified single-source repository that generates all 6 release
...
- HTML placeholders: `{{EDITION_LABEL}}`, `{{DB_DISPLAY}}`, `4.4.8`
