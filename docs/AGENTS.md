# AGENTS.md - AI Agent Infra with DB v4.3.0 Unified Repository Guide

> **v4.3.0** - The unified single-source repository that generates all 6 release
...
The current source and release metadata are `v4.3.0` dated `2026-07-29`.
...
- HTML placeholders: `{{EDITION_LABEL}}`, `{{DB_DISPLAY}}`, `4.3.0`
