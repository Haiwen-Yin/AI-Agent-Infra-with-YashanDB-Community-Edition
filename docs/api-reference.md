...
All functions use the `GRAPH_TABLE` SQL operator against `YASHAN_MEMORY_GRAPH`:
...
- `get_connection()` — Get AIADMIN pool connection (unrestricted by Role-Based Access Control)
