...
yaspy thin mode returns Chinese characters from AL32UTF8 databases with double-encoding (UTF-8 bytes interpreted as Latin-1 code points). The `_fix_encoding()` function auto-detects this:
