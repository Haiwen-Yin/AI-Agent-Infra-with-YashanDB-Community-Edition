...
Loops are durable: a run can be paused, resumed, monitored, and audited. All state lives in YashanDB tables, so a loop survives agent restarts and can be inspected by humans or other agents.
