...
| CREATE TABLE | Create 35 tables (6 partitioned, 5 reference-partitioned, 24 non-partitioned) |
...
| Privilege | Reason |
|-----------|--------|
| CREATE PROCEDURE | Create 16 PL/SQL packages |
...
| Privilege | Reason |
|-----------|--------|
| CREATE JOB | Create 17 DBMS_SCHEDULER jobs |
